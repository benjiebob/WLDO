...
model = torch.load('../data/pretrained/model_epoch_00000999.pth')
...
shape_cluster_means = torch.DoubleTensor(data['cluster_means'][1][None, :20])
shape_cluster_means_torch = shape_cluster_means.to(model_clean[betas_bias].device)

model_clean[betas_bias] = model_clean[betas_bias].double() - shape_cluster_means_torch[0]
...
torch.save(model_clean, '../data/pretrained/3501_00034_betas_v6.pth')
print ("Done")
